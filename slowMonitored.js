...
export default async function slowMonitored() {
    ...
    for (const APIevent of APIevents) {
        ...
        if(time && link && location) {
            ...
            if(norwegianTopic)  sendNotification(title, norwegianBody, APIevent, norwegianTopic);
            if(englishTopic)    sendNotification(title, englishBody, APIevent, englishTopic);
