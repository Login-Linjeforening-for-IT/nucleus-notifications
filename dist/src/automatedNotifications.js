...
export default function automatedNotifications() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let events = yield detailedEvents();
        let notified = yield readFile("notified");
        let slow = yield readFile("slow");
        // Returns if any variable is undefined
        if (events == undefined)
            return handleError({ file: "automatedNotifications", error: "events are initially undefined" });
        if (notified == undefined)
            return handleError({ file: "automatedNotifications", error: "notified are initially undefined" });
        if (slow == undefined)
            return handleError({ file: "automatedNotifications", error: "slow are initially undefined" });
        ...
        if (newEvents == undefined)
            return handleError({ file: "automatedNotifications", error: "newEvents is undefined" });
        ...
        if (sortedEvents == undefined)
            return handleError({ file: "automatedNotifications", error: "sortedEvents is undefined" });
        ...
        if (sortedNotified == undefined)
            return handleError({ file: "automatedNotifications", error: "sortedNotified is undefined" });
        if (sortedNotified.length)
            sortedNotified.forEach(event => { slow.push(event); });
        // Returns if any variable to be stored is undefined
        if (events == undefined)
            return handleError({ file: "automatedNotifications", error: "events is undefined when storing" });
        if (newNotified == undefined)
            return handleError({ file: "automatedNotifications", error: "newNotified is undefined when storing" });
        if (slow == undefined)
            return handleError({ file: "automatedNotifications", error: "slow is undefined when storing" });
