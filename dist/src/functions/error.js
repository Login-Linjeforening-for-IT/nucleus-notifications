        ...
        do {
            ...
            switch (arg) {
                ...
                case "notified": {
                    ...
                    if (!events)
                        handleError({ file: "heal", error: `Unable to heal ${arg}, events is undefined` });
                    ...
                    let fix = yield readFile("notified");
                ...
                case "slow": {
                    try {
                        ...
                        handleError({ file: "heal", error: JSON.stringify(error) });
                    }
                    // Breaks the function as the next case is not relevant
                    break;
                }
