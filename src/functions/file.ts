...
export default function file(file: string): string {
    switch (file) {
        case "10m":         return 'dist/src/data/intervals/events/10m.txt'
        case "30m":         return 'dist/src/data/intervals/events/30m.txt'
        case "1h":          return 'dist/src/data/intervals/events/1h.txt'
        case "2h":          return 'dist/src/data/intervals/events/2h.txt'
        case "3h":          return 'dist/src/data/intervals/events/3h.txt'
        case "6h":          return 'dist/src/data/intervals/events/6h.txt'
        case "1d":          return 'dist/src/data/intervals/events/1d.txt'
        case "2d":          return 'dist/src/data/intervals/events/2d.txt'
        case "1w":          return 'dist/src/data/intervals/events/1w.txt'
        case "a2h":         return 'dist/src/data/intervals/ads/2h.txt'
        case "a6h":         return 'dist/src/data/intervals/ads/6h.txt'
        case "a24h":        return 'dist/src/data/intervals/ads/24h.txt'
